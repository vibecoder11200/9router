          ...
          <div className="grid flex-1 grid-cols-5 items-center gap-1 rounded-lg border border-border bg-surface-2 p-1 sm:flex sm:flex-none">
            {PERIODS.map((p) => (
              <button
                ...
                disabled={fetching}
                className={`rounded-md px-3 py-1 text-sm font-medium transition-colors ${period === p.value ? "bg-primary text-primary-foreground shadow-sm" : "text-text-muted hover:bg-black/5 dark:hover:bg-white/5 hover:text-text-main"}`}
              >
                {p.label}
              </button>
            ))}
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="grid grid-cols-2 items-center gap-1 rounded-lg border border-border bg-surface-2 p-1 sm:flex">
            <button
              ...
              className={`px-3 py-1 rounded-md text-sm font-medium transition-colors ${viewMode === "costs" ? "bg-primary text-primary-foreground shadow-sm" : "text-text-muted hover:text-text-main hover:bg-black/5 dark:hover:bg-white/5"}`}
            >
              Costs
            </button>
            <button
              onClick={() => setViewMode("tokens")}
              className={`px-3 py-1 rounded-md text-sm font-medium transition-colors ${viewMode === "tokens" ? "bg-primary text-primary-foreground shadow-sm" : "text-text-muted hover:text-text-main hover:bg-black/5 dark:hover:bg-white/5"}`}
            >
              Tokens
            </button>
          </div>
