...
export const WEB_COOKIE_PROVIDERS = {
  "gemini-web": { id: "gemini-web", alias: "gweb", name: "Gemini Web", icon: "smart_toy", color: "#4285F4", textIcon: "GW", website: "https://gemini.google.com", authType: "cookie", authHint: "Paste your Gemini cookies (JSON format from cookie editor)", serviceKinds: ["llm"] },
